...
class TestFile
{
	...
	{
		File f1=new File("C:\\Users\\Dell\\java");
		if(f1.isDirectory())
		{
			...
			{
				File f2=new File("C:\\Users\\Dell\\java"+"//"+s[i]);
				if(f2.isDirectory())
				{
	   ...
	   {
		   System.out.println("C:\\Users\\Dell\\java" + " is not a directory");
	   }
...
boolean f=false;
	...
	{
		File f2=new File("C:\\Users\\Dell\\java"+"//"+filelist[i]);
